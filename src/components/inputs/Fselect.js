...
const Fselect = ({
    ...
    >
      ...
      >
        <View style={{ marginEnd: "auto" }}>
          <Text style={[STYLES.itemTextStyle, { color: textColor }]}>
            {item.title}
          </Text>
        </View>
        ...
        <View>
          ...
          >
            <AppIcon name="close" color="#fff" size={14} />
          </View>
        </View>
      </View>
    </TouchableOpacity>
  ...
  const renderItem = ({ item }) => {
    ...
    const backgroundColor = inSelected
      ...
      <Modal 
        ...
        onShow={() => {
          if (searchRef.current) {
            //console.log(" 337: Details of the current search ");
        ...
        >
          ...
          <FlatList
            ...
            data={
              searchList.length && searchRef.current?.getValue()?.length >= 1
                ? searchList
                : DATA
            }
